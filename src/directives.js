 ...
 * HTML element with the value of a given expression, and to update the text
 * content when the value of that expression changes. Typically, you write `{{ expression }}` 
 * and let Angular compile it into `<span ng:bind="expression"></span>` at bootstrap time.
 *
 * @element ANY
