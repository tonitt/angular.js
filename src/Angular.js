 ...
 * either an object or an array. The `iterator` function is invoked with `iterator(value, key)`, where
 * `value` is the value of an object property or an array element and `key` is the object property
 * key or array element index. Specifying a `context` for the function is optional.
 *
 ...
 *
 * @description
 * A function that performs no operations. This function can be useful when writing code
 ...
 *
 * @description
 * Checks to determine if a reference is undefined.
 *
 ...
 *
 * @description
 * Checks to determine if a reference is defined.
 *
 * @param {*} value Reference to check.
 ...
 *
 * @description
 * Checks to determine if a reference is an `Object`. Unlike in JavaScript, `null`s are not considered to be
 * objects.
 *
 * @param {*} value Reference to check.
 ...
 *
 * @description
 * Checks to determine if a reference is a `String`.
 *
 * @param {*} value Reference to check.
 ...
 *
 * @description
 * Checks to determine if a reference is a `Number`.
 *
 * @param {*} value Reference to check.
 ...
 *
 * @description
 * Checks to determine if a value is a date.
 *
 * @param {*} value Reference to check.
 ...
 *
 * @description
 * Check to determine if a reference is an `Array`.
 *
 * @param {*} value Reference to check.
 ...
 *
 * @description
 * Check to determine if a reference is a `Function`.
 *
 * @param {*} value Reference to check.
 ...
 * You can supply optional `args` that are are prebound to the function. This feature is also known 
 * as [function currying](http://en.wikipedia.org/wiki/Currying).
 *
